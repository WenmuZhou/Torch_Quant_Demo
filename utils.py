...
def train_model(model, train_loader, test_loader, device, learning_rate=1e-1, num_epochs=200):
    ...
    for epoch in range(num_epochs):
        ...
        print(f"Epoch: {epoch:03d}/{num_epochs:03d} Train Loss: {train_loss:.3f} Train Acc: {train_top1:.3f} Eval Top1: {eval_top1:.3f} Eval Top5: {eval_top5:.3f} Lr: {scheduler.get_last_lr()[0]:.4f}")
